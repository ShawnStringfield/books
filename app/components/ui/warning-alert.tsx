...
const WarningAlert = ({ message, actions, variant = 'warning', className }: WarningAlertProps) => {
  ...
  return (
    <div className={cn('flex flex-col p-3 text-sm border rounded-md', bgColor, borderColor, className)}>
      <div className="flex items-center gap-2">
        {!isWarning && <AlertCircle className="h-4 w-4 text-red-500 flex-shrink-0" />}
