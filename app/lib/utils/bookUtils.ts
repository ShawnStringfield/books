// This file has been moved from app/utils/bookUtils.ts to app/lib/utils/bookUtils.ts

// Any imports from other utility files would need to be updated like:
// FROM: import { someUtil } from '../utils/someUtil'
// TO:   import { someUtil } from '../lib/utils/someUtil'

// ... rest of original code content remains unchanged ...
...
import { safeDate } from "@/app/lib/utils/dateUtils";
